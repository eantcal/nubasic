...
public:
    ...
    ~termios_reset_t() noexcept { tcsetattr(STDIN_FILENO, TCSANOW, &_oldt); }
};
...
public:
    ...
    int cursor() const noexcept { return _cursor; }
    ...
    std::string get_cur_item() const { return (*this)[_cursor]; }

    svec_t get_history() const { return *this; }
