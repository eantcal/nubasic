...
struct instrblock_metadata_t
{
   ...
   using end_tbl_t =
      std::map < prog_pointer_t::line_number_t, prog_pointer_t::line_number_t > ;
...
public:
   ...
   void clear();
   void compile_begin(const prog_pointer_t& pc, const std::string& identifier = "");
   ...
   instrblock_t::handle_t begin_find(const prog_pointer_t::line_number_t& line);
