...
<Directory xmlns="http://schemas.microsoft.com/wix/2006/wi"
    ...
    <Directory Id="NuBASIC_MenuDir" Name="nuBASIC">
        <Component Id="CM_COMP_StartMenuShortcuts"
            ...
            <Shortcut Id="NuBASIC_TextConsole_Link"
                      Name="nuBASIC Text Console"
                      Description="nuBASIC text-mode command-line interpreter"
                      Target="[INSTALL_ROOT]bin\nubasic.exe"
                      WorkingDirectory="INSTALL_ROOT"/>
            <Shortcut Id="NuBASIC_GraphicsConsole_Link"
                      Name="nuBASIC Graphics Console"
                      Description="nuBASIC GDI console for graphical programs"
                      Target="[INSTALL_ROOT]bin\nubasicgdi.exe"
                      WorkingDirectory="INSTALL_ROOT"/>
