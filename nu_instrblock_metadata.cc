...
instrblock_t::handle_t instrblock_metadata_t::compile_end(const prog_pointer_t& pc)
{
...
instrblock_t::handle_t
instrblock_metadata_t::compile_exit_point(const prog_pointer_t& pc)
{
   if (build_stack.empty())
      return nullptr;
...
instrblock_t::handle_t
instrblock_metadata_t::begin_find(const prog_pointer_t::line_number_t& line)
{
...
instrblock_t::handle_t instrblock_metadata_t::begin_find(const prog_pointer_t& pc)
{
...
instrblock_t::handle_t instrblock_metadata_t::exit_find(const prog_pointer_t& pc)
{
