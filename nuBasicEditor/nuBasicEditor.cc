...
public:
   ...
   */
   HWND get_editor_hwnd() const throw( )
   {
      return _hwnd_editor;
   }
   ...
   */
   void set_editor_hwnd(HWND hwnd) throw( )
   {
      _hwnd_editor = hwnd;
   }
   ...
   * Set replace msg
   */
   void set_find_replace_msg(UINT msg) throw( )
   {
   ...
   * Get replace msg
   */
   UINT get_find_replace_msg() const throw( )
   {
   ...
   * Get instance handle
   */
   HINSTANCE get_instance_handle() const throw( )
   {
      return _hInstance;
   }
   ...
   * Set instance handle
   */
   void set_instance_handle(HINSTANCE hInst) throw( )
   {
      _hInstance = hInst;
   }
   ...
   * Get line count
   */
   int get_line_count() const throw( )
   {
   ...
   */
   void set_folding_margin(bool enable) throw( )
   {
   ...
   */
   int get_line_num_width() const throw( )
   {
      return int(
         LINENUM_WIDTH *
   ...
   */
   void toggle_bookmark(long line) throw( )
   {
   ...
   */
   bool add_bookmark(long line) throw( )
   {
   ...
   */
   bool show_execution_point(int line) throw( );


   /**
   * Show error line
   */
   bool show_error_line(int line) throw( );
   ...
   */
   bool remove_bookmark(long line) throw( )
   {
      if ( has_bookmark(line) )
      {
   ...
   */
   bool add_breakpoint(long line) throw( )
   {
   ...
   * \param line where to add breakpoint - lines start at 1
   */
   bool toggle_breakpoint(long line) throw( )
   {
   ...
   * \param line where to delete bookmark - lines start at 1
   */
   bool remove_breakpoint(long line) throw( )
   {
   ...
   */
   void remove_all_bookmarks() throw( )
   {
   ...
   */
   void remove_all_breakpoints() throw( )
   {
   ...
   */
   void reset_all_breakpoints() throw( )
   {
   ...
   */
   bool has_bookmark(long line) const throw( )
   {
   ...
   */
   bool has_breakpoint(long line) const throw( )
   {
   ...
   */
   LRESULT get_current_line() const throw( );
   ...
   */
   LRESULT get_current_colum() const throw( );
   ...
   */
   LRESULT get_current_position() const throw( );
   ...
   */
   LRESULT get_current_style() const throw( );
   ...
   */
   int get_fold_level() const throw( );


   /**
   * Set the fontname
   */
   void set_font(int style, const std::string& name) throw( )
   {
      send_command(
   ...
   */
   void set_font_height(int style, int height) throw( )
   {
   ...
   */
   void set_fg(int style, COLORREF crForeground) throw( )
   {
   ...
   */
   void set_bg(int style, COLORREF crBackground) throw( )
   {
   ...
   */
   void set_font_bold(int style, bool enable) throw( )
   {
   ...
   */
   void set_font_italic(int style, bool enable) throw( )
   {
   ...
   */
   void set_font_underline(int style, bool enable) throw( )
   {
   ...
   */
   bool get_overstrike() const throw( )
   {
   ...
   */
   void nu::editor_t::set_overstrike(bool enable) throw( )
   {
   ...
   */
   LRESULT get_selection_begin() const throw( )
   {
   ...
   *  otherwise -1 on error
   */
   LRESULT get_selection_end() const throw( )
   {
   ...
   */
   void invert_search_direction() throw( )
   {
   ...
   */
   bool get_search_direction() const throw( )
   {
   ...
   */
   bool rebuild_code(bool show_msg_error) throw( );


   /**
   * Remove functions reference menu
   */
   void remove_funcs_menu() throw( )
   {
      HMENU hmenu = GetMenu(gethwnd());

      if ( _func_submenu )
         DeleteMenu(hmenu, ( UINT ) _func_submenu, MF_BYCOMMAND);
   }

   /**
   * Create functions reference menu
   */
   void create_funcs_menu() throw( );


   /**
   * Resolve function line using id of "functions" menu
   */
   int resolve_funclinenum_from_id(int id) const throw( )
   {
...
LRESULT nu::editor_t::get_current_line() const throw( )
{
   return
...
LRESULT nu::editor_t::get_current_colum() const throw( )
{
...
LRESULT nu::editor_t::get_current_position() const throw( )
{
...
LRESULT nu::editor_t::get_current_style() const throw( )
{
   return send_command(
      SCI_GETSTYLEAT,
...
int nu::editor_t::get_fold_level() const throw( )
{
   int level =
      ( send_command(
...
void nu::editor_t::create_funcs_menu() throw( )
{
   ...
   hmenu = GetSubMenu(hmenu, IDM_MENU_SEACH_POS);
...
void nu::editor_t::alloc_console()
{
   ...
   SetConsoleScreenBufferSize(GetStdHandle(STD_ERROR_HANDLE), dwSize);
...
bool nu::editor_t::show_execution_point(int line) throw( )
{
   remove_prog_cnt_marker();
...
bool nu::editor_t::show_error_line(int line) throw( )
{
   remove_prog_cnt_marker();
...
bool nu::editor_t::rebuild_code(bool show_err_msg) throw( )
{
   remove_prog_cnt_marker();
   ...
   while ( i < doc_size )
   {
         ...
         ( ch == '\r' && i < doc_size && data[i + 1] == '\n' ) )
      {
         ...
         {
            try {
               g_editor.interpreter().update_program(line, 1);
            }
            catch ( ... )
            {
               old_style_prog = true;
   ...
   int nCmdShow)
{
   ...
   while ( going )
   {
      ...
      if ( g_editor.current_dialog() && going )
      {
         if ( !IsDialogMessage(g_editor.current_dialog(), &msg) )
         {
      ...
      {
         if ( TranslateAccelerator(g_editor.gethwnd(), hAccTable, &msg) == 0 )
         {
            TranslateMessage(&msg);
            DispatchMessage(&msg);
         }
