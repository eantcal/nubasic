...
static help_content_t _help_content[] =
{
   ...
   {
      lang_item_t::COMMAND, "run" ,
     "Executes the program currently in memory",
     "Run [linenumber]"
   },

   {
      lang_item_t::COMMAND, "cont",
   ...
   {
      lang_item_t::COMMAND, "rmbrk",
      "Remove a breakpoint",
      "RmBrk linenum"
   },

   {
     lang_item_t::COMMAND, "clrbrk",
     "Remove all active breakpoints",
     "ClrBrk"
   },

   {
      lang_item_t::COMMAND, "load",
      "Loads a program file in memory",
      "Load filename\n"
   },

   {
      lang_item_t::COMMAND, "exec",
      "Loads and runs a program file",
      "Exec filename\n"
   },

   {
      lang_item_t::COMMAND, "save",
      "Saves current program to file",
      "Save filename"
   },

   {
      lang_item_t::COMMAND, "pwd",
      "Retrieves the current working directory",
      "Pwd"
   },

   {
      lang_item_t::COMMAND, "cd",
     "Changes the current working directory",
     "Cd new_working_dir"
   },

   {
      lang_item_t::COMMAND, "list",
   ...
   {
      lang_item_t::COMMAND, "renum",
      "Renumbers program lines",
      "Renum [increment(default=10)]"
   },

   {
      lang_item_t::COMMAND, "tron",
      "Enables program tracing",
      "TrOn"
   },

   {
      lang_item_t::COMMAND, "troff",
      "Disables program tracing",
      "TrOff"
   },

   {
      lang_item_t::COMMAND, "ston",
      "Enables step mode",
      "StOn"
   },

   {
      lang_item_t::COMMAND, "stoff",
      "Disables step mode",
      "StOff"
   },

   {
      lang_item_t::COMMAND, "exit",
      "Quit the " NUBASIC_PROGRAM_NAME,
      "Exit"
   },
   ...
   {
      lang_item_t::COMMAND, "vars",
      "Show run-time data",
      "Vars"
   },

   {
      lang_item_t::COMMAND, "meta",
   ...
   {
      lang_item_t::FUNCTION, NU_BASIC_OP_INC ,
      "Increment unary operator",
      "++variable"
   },

   {
      lang_item_t::FUNCTION, NU_BASIC_OP_DEC ,
      "Decrement unary operator",
      "--variable"
   },

   {
      lang_item_t::FUNCTION, "pwd$",
      "Retrieves the current working directory",
      "Pwd$()"
   },

   {
      lang_item_t::FUNCTION, "min",
      "Returns the smallest of x and y",
      "Min(x,y)"
   },

   {
      lang_item_t::FUNCTION, "max",
   ...
   {
      lang_item_t::FUNCTION, "lcase",
      "Converts a string to lower-case.",
      "LCase[$](x)"
   },

   {
      lang_item_t::FUNCTION, "ucase",
   ...
   {
      lang_item_t::FUNCTION, "len",
      "Returns the number of characters in x$",
      "Len(x$)"
   },

   {
      lang_item_t::FUNCTION, "not",
   ...
   {
      lang_item_t::FUNCTION, "sqr",
      "Returns the square root of x",
      "Sqr(x)"
   },

   {
      lang_item_t::FUNCTION, "sqrt",
      "Returns the square root of x",
      "Sqrt(x)"
   },

   {
      lang_item_t::FUNCTION, "sinh",
   ...
   {
      lang_item_t::FUNCTION, "log",
      "Returns the natural logarithm of x",
      "Log(x)"
   },

   {
      lang_item_t::FUNCTION, "log10",
   ...
   {
      lang_item_t::FUNCTION, "unsetenv",
      "Unsets an environment variable",
      "UnsetEnv(var$)"
   },

   {
      lang_item_t::FUNCTION, "erase",
      "Deletes file from disk",
      "Delete(filename$)"
   },

   {
      lang_item_t::FUNCTION, "rmdir",
      "Deletes directory from disk",
      "RmDir(path$)"
   },

   {
      lang_item_t::FUNCTION, "mkdir",
