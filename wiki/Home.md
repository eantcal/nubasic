...
| Page | Description |
|------|-------------|
| [BASIC: A Language Built for Learning](BASIC-A-Language-Built-for-Learning) | Origins and history of the BASIC language |
| [Introduction to nuBASIC](Introduction-to-nuBASIC) | What nuBASIC is, its features, platforms, and design philosophy |
...
For more detail, see [Getting Started](Getting-Started).
