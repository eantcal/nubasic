...
using _stringbuf = std::basic_stringbuf<char_t, std::char_traits<char_t>,
    std::allocator<char_t>>;
using _istringstream = std::basic_istringstream<char_t,
    std::char_traits<char_t>, std::allocator<char_t>>;
using _ostringstream = std::basic_ostringstream<char_t,
    std::char_traits<char_t>, std::allocator<char_t>>;
using _stringstream = std::basic_stringstream<char_t, std::char_traits<char_t>,
    std::allocator<char_t>>;
