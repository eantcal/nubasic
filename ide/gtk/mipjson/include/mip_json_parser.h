...
private:
    ...
    struct with {
        ...
        with(std::unique_ptr<token_t>& tkn) noexcept
            : _tkn(tkn)
        {
        }
    ...
    static constexpr const char_t* err_reading_stream()
    {
        return _T("reading input stream");
    }
    static constexpr const char_t* err_val_expected()
    {
        return _T("value expected");
    }
    static constexpr const char_t* err_inv_value()
    {
        return _T("invalid value");
    }
    static constexpr const char_t* err_str_expected()
    {
        return _T("string expected");
    }
    static constexpr const char_t* err_colon_expected()
    {
        return _T("':' expected");
    }
    static constexpr const char_t* err_unmatching_curly_brace()
    {
        return _T("'}' or ',' expected");
    }
    static constexpr const char_t* err_curly_brace_expected()
    {
        return _T("'{' expected");
    }
